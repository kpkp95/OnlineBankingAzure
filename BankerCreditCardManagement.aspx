            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                   ...
                   <div class="row">
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BankingSystemConnectionString %>" SelectCommand="SELECT * FROM [CreditCard]"></asp:SqlDataSource>
                     <div class="col">

                         <asp:GridView ID="GridView1" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="CreditCardNumber" DataSourceID="SqlDataSource1">
                             <Columns>
                                 ...
                                 <asp:BoundField DataField="ExpityDate" HeaderText="Expity Date" SortExpression="ExpityDate" DataFormatString="{0:dd/MM/yyyy} " />
