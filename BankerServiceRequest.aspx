                  ...
                  <div class="row">
                   ...
                   <div class="row">
                     ...
                     <div class="col">
                         ...
                         <asp:GridView ID="GridView1" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="ServiceRequestID" DataSourceID="SqlDataSource1">
                             <Columns>
                                 <asp:BoundField DataField="ServiceRequestID" HeaderText="ServiceRequestID" ReadOnly="True" SortExpression="ServiceRequestID" InsertVisible="False" />
                                 <asp:BoundField DataField="UserID" HeaderText="UserID" SortExpression="UserID" />
                                 <asp:BoundField DataField="ServiceRequestType" HeaderText="ServiceRequestType" SortExpression="ServiceRequestType" />
                                 <asp:BoundField DataField="ServiceRequestDescription" HeaderText="ServiceRequestDescription" SortExpression="ServiceRequestDescription" />
